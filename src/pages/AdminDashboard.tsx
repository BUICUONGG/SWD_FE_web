...
const fakeData = {
  ...
  recentActivities: [
    {
      id: 1,
      action: "Sinh viên Nguyễn Văn A đăng ký khóa học SWD392",
      time: "2 phút trước",
      type: "info",
    },
    {
      id: 2,
      action: 'Mentor Trần Thị B phê duyệt ý tưởng "E-commerce Platform"',
      time: "15 phút trước",
      type: "success",
    },
    {
      id: 3,
      action: "Nhóm 5 nộp báo cáo cuối kỳ",
      time: "1 giờ trước",
      type: "warning",
    },
    {
      id: 4,
      action: "Admin tạo học kỳ mới Fall 2025",
      time: "3 giờ trước",
      type: "success",
    },
  ],
  ...
  const userColumns = [
    ...
    },
    {
      ...
      render: (role: string) => (
        <Tag
          color={
            role === "admin" ? "red" : role === "mentor" ? "blue" : "green"
          }
        >
          {role.toUpperCase()}
        </Tag>
  ...
  const ideaData = [
    {
      ...
      description:
        "Xây dựng nền tảng thương mại điện tử với tính năng thanh toán online, quản lý kho hàng và hệ thống đánh giá sản phẩm",
      owner: "Nguyễn Văn A",
      team: "Team Alpha",
    ...
    },
    {
      ...
      description:
        "Hệ thống quản lý công việc cho nhóm với tính năng phân công, theo dõi tiến độ và thống kê hiệu suất",
      owner: "Trần Thị B",
      team: "Team Beta",
    ...
    },
    {
      ...
      description:
        "Ứng dụng mạng xã hội với tính năng chia sẻ hình ảnh, video, tin nhắn và tương tác realtime",
      owner: "Lê Văn C",
      team: "Team Gamma",
    ...
    },
    {
      ...
      description:
        "Hệ thống quản lý học tập với tính năng tạo khóa học, bài tập trực tuyến và theo dõi kết quả học tập",
      owner: "Phạm Thị D",
      team: "Team Delta",
    ...
    },
    {
      ...
      description:
        "Ứng dụng giao đồ ăn với tính năng đặt hàng, theo dõi shipper và thanh toán đa dạng",
      owner: "Hoàng Văn E",
      team: "Team Epsilon",
