...
const UserProfile: React.FC = () => {
  ...
  const getUserAvatar = () => {
    ...
    return `https://ui-avatars.com/api/?name=${encodeURIComponent(user?.fullName || 'Student')}&background=${colors[colorIndex].slice(1)}&color=fff&size=256&font-size=0.5`;
  };
    ...
    <StudentLayout>
      <div style={{ padding: '24px', background: '#f0f2f5', minHeight: 'calc(100vh - 128px)' }}>
        ...
        <Row gutter={[16, 16]}>
          ...
          <Col xs={24} lg={8}>
            {/* Academic Stats */}
            <Card title={<><StarOutlined /> Thống kê học tập</>} style={{ marginBottom: 16 }}>
              <Statistic
              ...
              />
              <Progress percent={85} strokeColor="#faad14" style={{ marginTop: 16 }} />
              ...
              />
              <Progress percent={37.5} strokeColor="#52c41a" style={{ marginTop: 16 }} />
